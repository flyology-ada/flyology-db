...
package body Flyology.DB.Manifest_Format_Tests is
   ...
   pragma Compile_Time_Error
     (Manifests.Max_Manifest_Image_Length /= 18_312,
      "manifest maximum image width changed");
   ...
   procedure Set_Name
     (Item : in out Manifests.Column_Family_Configuration;
   ...
   begin
      ...
      Set_Name
        (Result.Families (1),
         [Character'Pos ('a'), Character'Pos ('c'), Character'Pos ('c'), Character'Pos ('o'),
          Character'Pos ('u'), Character'Pos ('n'), Character'Pos ('t'), Character'Pos ('s')]);
      Result.Families (2).ID := 2;
      Result.Families (2).Max_Key_Bytes := 20;
      Result.Families (2).Max_Value_Bytes := 400;
      Set_Name
        (Result.Families (2),
         [Character'Pos ('a'), Character'Pos ('u'), Character'Pos ('d'), Character'Pos ('i'),
          Character'Pos ('t'), Character'Pos ('-'), 16#CF#, 16#80#]);
      return Result;
   end Root_Manifest;
   ...
   Golden : constant Formats.Byte_Array (0 .. Fixture_Length - 1) :=
     [16#46#, 16#4C#, 16#59#, 16#43#, 16#46#, 16#4D#, 16#30#, 16#31#,
      16#00#, 16#01#, 16#03#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
      16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
      16#00#, 16#00#, 16#00#, 16#01#, 16#00#, 16#00#, 16#00#, 16#C4#,
      16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#48#,
      16#BF#, 16#15#, 16#3F#, 16#5D#, 16#00#, 16#00#, 16#00#, 16#00#,
      16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
      ...
      16#00#, 16#00#, 16#00#, 16#40#, 16#00#, 16#00#, 16#00#, 16#40#,
      16#00#, 16#00#, 16#00#, 16#40#, 16#00#, 16#00#, 16#00#, 16#08#,
      16#00#, 16#00#, 16#00#, 16#40#, 16#00#, 16#00#, 16#00#, 16#40#,
      16#00#, 16#00#, 16#01#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
      16#00#, 16#20#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
      16#01#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
      16#04#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#01#,
      16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
      16#00#, 16#00#, 16#10#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#,
      16#00#, 16#10#, 16#00#, 16#00#, 16#00#, 16#08#, 16#00#, 16#00#,
      16#61#, 16#63#, 16#63#, 16#6F#, 16#75#, 16#6E#, 16#74#, 16#73#,
      16#00#, 16#00#, 16#00#, 16#02#, 16#00#, 16#00#, 16#00#, 16#00#,
      16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#14#,
      16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#01#, 16#90#,
      16#00#, 16#08#, 16#00#, 16#00#, 16#61#, 16#75#, 16#64#, 16#69#,
      16#74#, 16#2D#, 16#CF#, 16#80#, 16#64#, 16#0E#, 16#E8#, 16#46#];
   ...
   procedure Repair_Checksums
     (Item : in out Manifests.Manifest_Image; Length : Natural)
   is
   begin
      Item (40 .. 43) := [others => 0];
   ...
   procedure Expect_Default_Decode
     (Item : Formats.Byte_Array; Expected : Manifests.Decode_Status; Context : String)
   is
   begin
   ...
   begin
      ...
      Manifests.Decode_Manifest
        (Golden, Fixture.Database_ID, Manifests.Default_Reader_Caps, Value, Status);
   ...
   begin
      ...
      Expect_Default_Decode
        (Corrupt (0 .. Fixture_Length - 1), Manifests.Unsupported_Version, "version");
      Corrupt (0 .. Fixture_Length - 1) := Golden;
      Corrupt (10) := 2;
      Repair_Checksums (Corrupt, Fixture_Length);
      Expect_Default_Decode
        (Corrupt (0 .. Fixture_Length - 1), Manifests.Invalid_Object_Kind, "kind");
      Corrupt (0 .. Fixture_Length - 1) := Golden;
      Corrupt (11) := 1;
      Repair_Checksums (Corrupt, Fixture_Length);
      ...
      Repair_Checksums (Corrupt, Fixture_Length);
      Expect_Default_Decode
        (Corrupt (0 .. Fixture_Length - 1), Manifests.Invalid_Manifest_State,
   ...
   begin
      ...
      Repair_Checksums (Corrupt, Fixture_Length);
      Expect_Default_Decode
        (Corrupt (0 .. Fixture_Length - 1), Manifests.Invalid_Name, "empty family name");
      Corrupt (0 .. Fixture_Length - 1) := Golden;
      Put_U32 (Corrupt, 196, 0);
      Repair_Checksums (Corrupt, Fixture_Length);
      Expect_Default_Decode
        (Corrupt (0 .. Fixture_Length - 1), Manifests.Invalid_Family, "zero family ID");
      Corrupt (0 .. Fixture_Length - 1) := Golden;
      Put_U32 (Corrupt, 200, 1);
      Repair_Checksums (Corrupt, Fixture_Length);
      Expect_Default_Decode
        (Corrupt (0 .. Fixture_Length - 1), Manifests.Invalid_Family, "family flags");
      Corrupt (0 .. Fixture_Length - 1) := Golden;
      ...
      Repair_Checksums (Corrupt, Fixture_Length);
      Expect_Default_Decode
        (Corrupt (0 .. Fixture_Length - 1), Manifests.Duplicate_Name, "duplicate name");
      ...
      Repair_Checksums (Corrupt, Fixture_Length);
      Expect_Default_Decode
        (Corrupt (0 .. Fixture_Length - 1), Manifests.Invalid_Name, "UTF-8 surrogate");
      Corrupt (0 .. Fixture_Length - 1) := Golden;
   ...
   procedure Test_Limits_And_Caps is
      ...
      Exact   : constant Manifests.Reader_Caps :=
        (Families => 2, Name_Bytes => 8, Payload_Bytes => 72,
         Key_Bytes => 4 * 1_024, Value_Bytes => 1_024 * 1_024);
   begin
      Expect_Decode (Golden, Exact, Manifests.Decoded, "exact caps");
      Expect_Decode
        (Golden, (Exact with delta Families => 1), Manifests.Limit_Exceeded, "family cap");
      Expect_Decode
        (Golden, (Exact with delta Name_Bytes => 7), Manifests.Limit_Exceeded, "name cap");
      Expect_Decode
        (Golden, (Exact with delta Payload_Bytes => 71), Manifests.Limit_Exceeded, "payload cap");
      Expect_Decode
        (Golden, (Exact with delta Key_Bytes => 4 * 1_024 - 1), Manifests.Limit_Exceeded, "key cap");
      Expect_Decode
        (Golden, (Exact with delta Value_Bytes => 1_024 * 1_024 - 1),
         Manifests.Limit_Exceeded, "value cap");
      ...
      Repair_Checksums (Corrupt, Fixture_Length);
      Expect_Default_Decode
        (Corrupt (0 .. Fixture_Length - 1), Manifests.Invalid_Family, "zero max key");
      Corrupt (0 .. Fixture_Length - 1) := Golden;
      Put_U32 (Corrupt, 160, 65);
      Repair_Checksums (Corrupt, Fixture_Length);
      Expect_Default_Decode
        (Corrupt (0 .. Fixture_Length - 1), Manifests.Limit_Exceeded, "mutation cap one-over");

      declare
         type Offset_List is array (Positive range <>) of Natural;
         Count_Offsets : constant Offset_List := [144, 148, 152, 156, 160, 164, 168];
      begin
         for Offset of Count_Offsets loop
            ...
            Repair_Checksums (Corrupt, Fixture_Length);
            Expect_Default_Decode
              (Corrupt (0 .. Fixture_Length - 1), Manifests.Limit_Exceeded,
               "U32 maximum configured count was not a resource limit");
            Corrupt (0 .. Fixture_Length - 1) := Golden;
            Put_U32 (Corrupt, Offset, 0);
            Repair_Checksums (Corrupt, Fixture_Length);
            Expect_Default_Decode
              (Corrupt (0 .. Fixture_Length - 1), Manifests.Invalid_Limits,
               "zero configured count accepted");
         end loop;
      end;
      ...
      Repair_Checksums (Corrupt, Fixture_Length);
      Expect_Default_Decode
        (Corrupt (0 .. Fixture_Length - 1), Manifests.Decoded,
      ...
      Expect_Default_Decode
        (Corrupt (0 .. Fixture_Length - 1), Manifests.Invalid_Limits,
         "zero live-state budget accepted");
      Corrupt (0 .. Fixture_Length - 1) := Golden;
      Put_U64 (Corrupt, 212, 0);
      Repair_Checksums (Corrupt, Fixture_Length);
      Expect_Default_Decode
        (Corrupt (0 .. Fixture_Length - 1), Manifests.Invalid_Family, "zero max value");
      Corrupt (0 .. Fixture_Length - 1) := Golden;
      ...
      Repair_Checksums (Corrupt, Fixture_Length);
      Expect_Default_Decode
        (Corrupt (0 .. Fixture_Length - 1), Manifests.Invalid_Length,
         "U64 payload extent converted unsafely");

      Corrupt (0 .. Fixture_Length - 1) := Golden;
      Corrupt (40) := Corrupt (40) xor 1;
      Expect_Decode
        (Corrupt (0 .. Fixture_Length - 1), (Families => 0, others => <>),
         Manifests.Header_Checksum_Failed, "cap hid corrupt header");
   ...
   begin
      ...
      Manifests.Decode_Manifest
        (Image, Maximum.Database_ID, Manifests.Default_Reader_Caps, Value, Status);
      ...
      begin
         ...
         Expect_Decode
           (One_Over, Manifests.Default_Reader_Caps, Manifests.Limit_Exceeded,
   ...
   begin
      ...
      for Dimension in Positive range 1 .. 10 loop
         ...
         begin
            case Dimension is
               ...
               when 6 => Wrong.Latest_Batch := ID (99);
               when 7 => Wrong.Epoch := 2;
               when 8 => Wrong.Predecessor_Transition := ID (99);
               when 9 =>
      ...
      for Dimension in Positive range 1 .. 9 loop
         ...
         begin
            case Dimension is
               ...
               when 6 => Wrong.Transition_ID := ID (99);
               when 7 => Wrong.Latest_Batch := ID (99);
               when 8 => Wrong.Transition_Number := 2;
               when 9 => Wrong.Predecessor_Transition := ID (99);
            end case;
      ...
      Manifests.Decode_Manifest
        (Image (0 .. Length - 1), Current.Database_ID, Manifests.Default_Reader_Caps,
         Decoded_Value, Decode_Result);
      ...
      Repair_Checksums (Corrupt, Length);
      Expect_Default_Decode
        (Corrupt (0 .. Length - 1), Manifests.Invalid_Manifest_State,
         "zero expected HEAD number");
      Corrupt := Image;
      ...
      Expect_Default_Decode
        (Corrupt (0 .. Length - 1), Manifests.Invalid_Manifest_State,
         "successor revision did not advance");
      Corrupt := Image;
         ...
         for Dimension in Positive range 1 .. 9 loop
            ...
            begin
               case Dimension is
                  ...
                  when 6 => Wrong.Latest_Manifest := ID (99);
                  when 7 => Wrong.Transition_ID := ID (99);
                  when 8 => Wrong.Predecessor_Transition := ID (99);
                  when 9 => Wrong.Transition_Number := 3;
               end case;
