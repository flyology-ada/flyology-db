...
| 6 Compaction/retention | Conservative compaction, snapshot retention, atomic manifests, orphan GC | Formal replacement boundary frozen; operational work pending |
